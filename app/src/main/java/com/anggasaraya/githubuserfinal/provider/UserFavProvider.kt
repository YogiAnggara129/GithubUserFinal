package com.anggasaraya.githubuserfinal.provider
...
import com.anggasaraya.githubuserfinal.db.DatabaseContract.Companion.AUTHORITY
...
import com.anggasaraya.githubuserfinal.db.UserFavHelper
...
class UserFavProvider : ContentProvider() {
    ...
    override fun query(
        ...
        return when (sUriMatcher.match(uri)) {
            NOTE -> userFavHelper.queryAll()
            NOTE_ID -> userFavHelper.queryById(uri.lastPathSegment.toString())
            else -> null
        }
    }
